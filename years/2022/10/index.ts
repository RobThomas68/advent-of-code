...
// solution path: /home/rob/Workspaces/advent-of-code/years/2022/10/index.ts
// data path    : /home/rob/Workspaces/advent-of-code/years/2022/10/data.txt
...
async function p2022day10_part2(input: string, ...params: any[]) {
	...
	function doCycle() {
		if (_.includes([x - 1, x, x + 1], cycle - 1)) {
			pixels += "#";
		} else {
			pixels += ".";
		}
